...
jsx_new = """<div className="scattered-cards-container animate-fade-in">
                    ...
                    <img src="Kimage.webp" className="scattered-card" style={{top: '55%', right: '5%', transform: 'rotate(-30deg)'}} alt="" />
                    <img src="Aimage.webp" className="scattered-card" style={{bottom: '12%', left: '20%', transform: 'rotate(60deg)'}} alt="" />
                    <img src="2image.webp" className="scattered-card" style={{bottom: '8%', right: '18%', transform: 'rotate(-75deg)'}} alt="" />
...
print("Successfully reduced card size further and shuffled positions")
