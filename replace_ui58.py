...
new_touch_logic = """      const isSwipingRef = React.useRef(false); // スワイプ中判定
...
if old_touch_logic in content:
    ...
    print("Error: Could not find old_touch_logic in index.html")
    sys.exit(1)

with open('index.html', 'w', encoding='utf-8') as f:
    f.write(content)

print("Successfully added flick-to-play feature")
